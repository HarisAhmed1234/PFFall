 ...
 * Name: Haris Ahmed
 * Date: 18/10/23
 * Description: produces an n x n grid, accepts user input for each 3x3 matrix included in it,
 *             and prints out a matrix with the greatest value of each matrix
 */
